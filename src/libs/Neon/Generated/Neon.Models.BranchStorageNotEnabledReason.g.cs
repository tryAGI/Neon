...
{
    /// <summary>
    /// Machine-readable reason why object storage is unavailable:<br/>
    /// - `org_not_entitled`: the org's `PlatformBranchableStorage` feature flag is off.<br/>
    /// - `region_unavailable`: the project's region has no object storage admin service wired.<br/>
    /// - `branch_directory_missing`: the branch is not registered in the object storage service.<br/>
    ...
    {
        /// <summary>
        /// the branch is not registered in the object storage service.
        /// </summary>
        ...
        OrgNotEntitled,
        /// <summary>
        /// the project's region has no object storage admin service wired.
        /// </summary>
        RegionUnavailable,
    }
