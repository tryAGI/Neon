...
namespace Neon
{
    public partial class BucketsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_DeleteProjectBranchBucketObjectSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_DeleteProjectBranchBucketObjectSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_DeleteProjectBranchBucketObjectSecurityRequirement0,
            };
        partial void PrepareDeleteProjectBranchBucketObjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string bucketName,
            ref string objectKey);
        partial void PrepareDeleteProjectBranchBucketObjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string bucketName,
            string objectKey);
        partial void ProcessDeleteProjectBranchBucketObjectResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteProjectBranchBucketObjectAsync(
            string projectId,
            string branchId,
            string bucketName,
            string objectKey,
        ...
        {
            await DeleteProjectBranchBucketObjectAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse> DeleteProjectBranchBucketObjectAsResponseAsync(
            string projectId,
            string branchId,
            string bucketName,
            string objectKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteProjectBranchBucketObjectArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteProjectBranchBucketObjectSecurityRequirements,
                operationName: "DeleteProjectBranchBucketObjectAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/buckets/{bucketName}/objects/{objectKey}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteProjectBranchBucketObjectRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteProjectBranchBucketObjectAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/buckets/{bucketName}/objects/{objectKey}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteProjectBranchBucketObjectResponse(
                    httpClient: HttpClient,
