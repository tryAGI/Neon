...
namespace Neon.JsonConverters
{
    ...
    public class EndpointOperationsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Neon.EndpointOperations>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        response1 = global::System.Text.Json.JsonSerializer.Deserialize<global::Neon.EndpointResponse>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Response1, typeof(global::Neon.EndpointResponse), options);
            }
