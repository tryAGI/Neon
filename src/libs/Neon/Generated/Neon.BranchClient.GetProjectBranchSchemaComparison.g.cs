...
namespace Neon
{
    public partial class BranchClient
    {
        ...
        partial void PrepareGetProjectBranchSchemaComparisonArguments(
            ...
            ref string branchId,
            ref string? baseBranchId,
            ref string dbName,
            ref string? lsn,
            ref global::System.DateTime? timestamp,
            ref string? baseLsn,
            ref global::System.DateTime? baseTimestamp);
        partial void PrepareGetProjectBranchSchemaComparisonRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? baseLsn,
            global::System.DateTime? baseTimestamp);
        partial void ProcessGetProjectBranchSchemaComparisonResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectBranchSchemaComparisonResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.BranchSchemaCompareResponse> GetProjectBranchSchemaComparisonAsync(
            string projectId,
            string branchId,
            string dbName,
        ...
        {
            var __response = await GetProjectBranchSchemaComparisonAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                dbName: dbName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.BranchSchemaCompareResponse>> GetProjectBranchSchemaComparisonAsResponseAsync(
            string projectId,
            string branchId,
            string dbName,
            string? baseBranchId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetProjectBranchSchemaComparisonArguments(
                httpClient: HttpClient,
                projectId: ref projectId,
                branchId: ref branchId,
                baseBranchId: ref baseBranchId,
                dbName: ref dbName,
                lsn: ref lsn,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("base_branch_id", baseBranchId)
                                .AddRequiredParameter("db_name", dbName)
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProjectBranchSchemaComparisonAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/compare_schema\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProjectBranchSchemaComparisonResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProjectBranchSchemaComparisonResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.BranchSchemaCompareResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.BranchSchemaCompareResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.BranchSchemaCompareResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
