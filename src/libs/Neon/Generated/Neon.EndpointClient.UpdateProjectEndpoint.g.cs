...
namespace Neon
{
    public partial class EndpointClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateProjectEndpointSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateProjectEndpointSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateProjectEndpointSecurityRequirement0,
            };
        partial void PrepareUpdateProjectEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string endpointId,
            global::Neon.EndpointUpdateRequest request);
        partial void PrepareUpdateProjectEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string endpointId,
            global::Neon.EndpointUpdateRequest request);
        partial void ProcessUpdateProjectEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EndpointOperations> UpdateProjectEndpointAsync(
            string projectId,
            string endpointId,
        ...
        {
            var __response = await UpdateProjectEndpointAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.EndpointOperations>> UpdateProjectEndpointAsResponseAsync(
            string projectId,
            string endpointId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectEndpointArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectEndpointSecurityRequirements,
                operationName: "UpdateProjectEndpointAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateProjectEndpointAsync",
                                pathTemplate: "$\"/projects/{projectId}/endpoints/{endpointId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EndpointOperations> UpdateProjectEndpointAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.EndpointUpdateRequest
            {
                Endpoint = endpoint,
            };

            return await UpdateProjectEndpointAsync(
                projectId: projectId,
                endpointId: endpointId,
                request: __request,
                requestOptions: requestOptions,
