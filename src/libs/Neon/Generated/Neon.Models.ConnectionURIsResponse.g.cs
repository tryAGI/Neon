...
namespace Neon
{
    ...
    public sealed partial class ConnectionURIsResponse
    {
        ...
        public required global::System.Collections.Generic.IList<global::Neon.ConnectionDetails> ConnectionUris { get; set; }
...
#endif
        public ConnectionURIsResponse(
            global::System.Collections.Generic.IList<global::Neon.ConnectionDetails> connectionUris)
        {
            this.ConnectionUris = connectionUris ?? throw new global::System.ArgumentNullException(nameof(connectionUris));
        }
