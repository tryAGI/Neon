...
namespace Neon
{
    public partial class EndpointClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_CreateProjectEndpointSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_CreateProjectEndpointSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_CreateProjectEndpointSecurityRequirement0,
            };
        partial void PrepareCreateProjectEndpointArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            global::Neon.EndpointCreateRequest request);
        partial void PrepareCreateProjectEndpointRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            global::Neon.EndpointCreateRequest request);
        partial void ProcessCreateProjectEndpointResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateProjectEndpointResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EndpointOperations> CreateProjectEndpointAsync(
            string projectId,
        ...
        {
            var __response = await CreateProjectEndpointAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.EndpointOperations>> CreateProjectEndpointAsResponseAsync(
            string projectId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateProjectEndpointArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateProjectEndpointSecurityRequirements,
                operationName: "CreateProjectEndpointAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateProjectEndpointRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateProjectEndpointAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateProjectEndpointResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateProjectEndpointResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EndpointOperations> CreateProjectEndpointAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.EndpointCreateRequest
            {
                Endpoint = endpoint,
            };

            return await CreateProjectEndpointAsync(
                projectId: projectId,
                request: __request,
                requestOptions: requestOptions,
