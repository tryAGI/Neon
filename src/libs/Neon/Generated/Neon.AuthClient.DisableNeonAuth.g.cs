...
namespace Neon
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_DisableNeonAuthSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_DisableNeonAuthSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_DisableNeonAuthSecurityRequirement0,
            };
        partial void PrepareDisableNeonAuthArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            global::Neon.DisableNeonAuthRequest request);
        partial void PrepareDisableNeonAuthRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            global::Neon.DisableNeonAuthRequest request);
        partial void ProcessDisableNeonAuthResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DisableNeonAuthAsync(
            string projectId,
            string branchId,
        ...
        {
            await DisableNeonAuthAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse> DisableNeonAuthAsResponseAsync(
            string projectId,
            string branchId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDisableNeonAuthArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DisableNeonAuthSecurityRequirements,
                operationName: "DisableNeonAuthAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DisableNeonAuthAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDisableNeonAuthResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task DisableNeonAuthAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.DisableNeonAuthRequest
            {
                DeleteData = deleteData,
            };

            await DisableNeonAuthAsync(
                projectId: projectId,
                branchId: branchId,
                request: __request,
                requestOptions: requestOptions,
