...
namespace Neon
{
    public partial class BranchClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateProjectBranchDatabaseSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateProjectBranchDatabaseSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateProjectBranchDatabaseSecurityRequirement0,
            };
        partial void PrepareUpdateProjectBranchDatabaseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string databaseName,
            global::Neon.DatabaseUpdateRequest request);
        partial void PrepareUpdateProjectBranchDatabaseRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string databaseName,
            global::Neon.DatabaseUpdateRequest request);
        partial void ProcessUpdateProjectBranchDatabaseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectBranchDatabaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.DatabaseOperations> UpdateProjectBranchDatabaseAsync(
            string projectId,
            string branchId,
            string databaseName,
        ...
        {
            var __response = await UpdateProjectBranchDatabaseAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.DatabaseOperations>> UpdateProjectBranchDatabaseAsResponseAsync(
            string projectId,
            string branchId,
            string databaseName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectBranchDatabaseArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectBranchDatabaseSecurityRequirements,
                operationName: "UpdateProjectBranchDatabaseAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateProjectBranchDatabaseAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/databases/{databaseName}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectBranchDatabaseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectBranchDatabaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.DatabaseOperations> UpdateProjectBranchDatabaseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.DatabaseUpdateRequest
            {
                Database = database,
            };

            return await UpdateProjectBranchDatabaseAsync(
                projectId: projectId,
                branchId: branchId,
                databaseName: databaseName,
                request: __request,
