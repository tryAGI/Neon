...
namespace Neon
{
    public partial class ProjectClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_GetProjectAdvisorSecurityIssuesSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_GetProjectAdvisorSecurityIssuesSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_GetProjectAdvisorSecurityIssuesSecurityRequirement0,
            };
        ...
        {
            var __response = await GetProjectAdvisorSecurityIssuesAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.GetProjectAdvisorSecurityIssuesResponse>> GetProjectAdvisorSecurityIssuesAsResponseAsync(
            string projectId,
            string? branchId = default,
            string? databaseName = default,
            global::Neon.AdvisorCategory? category = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetProjectAdvisorSecurityIssuesSecurityRequirements,
                operationName: "GetProjectAdvisorSecurityIssuesAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProjectAdvisorSecurityIssuesAsync",
                                pathTemplate: "$\"/projects/{projectId}/advisors\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.GetProjectAdvisorSecurityIssuesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.GetProjectAdvisorSecurityIssuesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.GetProjectAdvisorSecurityIssuesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
