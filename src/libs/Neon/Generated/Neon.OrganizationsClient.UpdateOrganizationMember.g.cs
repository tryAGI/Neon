...
namespace Neon
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateOrganizationMemberSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateOrganizationMemberSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateOrganizationMemberSecurityRequirement0,
            };
        partial void PrepareUpdateOrganizationMemberArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            ref string memberId,
            global::Neon.OrganizationMemberUpdateRequest request);
        partial void PrepareUpdateOrganizationMemberRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            string memberId,
            global::Neon.OrganizationMemberUpdateRequest request);
        partial void ProcessUpdateOrganizationMemberResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateOrganizationMemberResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.Member> UpdateOrganizationMemberAsync(
            string orgId,
            string memberId,
        ...
        {
            var __response = await UpdateOrganizationMemberAsResponseAsync(
                orgId: orgId,
                memberId: memberId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.Member>> UpdateOrganizationMemberAsResponseAsync(
            string orgId,
            string memberId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateOrganizationMemberArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateOrganizationMemberSecurityRequirements,
                operationName: "UpdateOrganizationMemberAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateOrganizationMemberAsync",
                                pathTemplate: "$\"/organizations/{orgId}/members/{memberId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateOrganizationMemberResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateOrganizationMemberResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.Member.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.Member>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.Member.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.Member> UpdateOrganizationMemberAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.OrganizationMemberUpdateRequest
            {
                Role = role,
            };

            return await UpdateOrganizationMemberAsync(
                orgId: orgId,
                memberId: memberId,
                request: __request,
                requestOptions: requestOptions,
