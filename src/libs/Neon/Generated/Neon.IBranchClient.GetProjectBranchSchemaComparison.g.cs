...
namespace Neon
{
    public partial interface IBranchClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.BranchSchemaCompareResponse>> GetProjectBranchSchemaComparisonAsResponseAsync(
            string projectId,
            string branchId,
            string dbName,
            string? baseBranchId = default,
