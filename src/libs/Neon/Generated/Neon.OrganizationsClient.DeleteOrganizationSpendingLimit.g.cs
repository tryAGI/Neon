...
namespace Neon
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_DeleteOrganizationSpendingLimitSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_DeleteOrganizationSpendingLimitSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_DeleteOrganizationSpendingLimitSecurityRequirement0,
            };
        partial void PrepareDeleteOrganizationSpendingLimitArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId);
        partial void PrepareDeleteOrganizationSpendingLimitRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId);
        partial void ProcessDeleteOrganizationSpendingLimitResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteOrganizationSpendingLimitResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EmptyResponse> DeleteOrganizationSpendingLimitAsync(
            string orgId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteOrganizationSpendingLimitAsResponseAsync(
                orgId: orgId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.EmptyResponse>> DeleteOrganizationSpendingLimitAsResponseAsync(
            string orgId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteOrganizationSpendingLimitArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteOrganizationSpendingLimitSecurityRequirements,
                operationName: "DeleteOrganizationSpendingLimitAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteOrganizationSpendingLimitAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteOrganizationSpendingLimitResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteOrganizationSpendingLimitResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.EmptyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.EmptyResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.EmptyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
