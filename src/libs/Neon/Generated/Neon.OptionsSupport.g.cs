...
namespace Neon
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Neon.AutoSDKRetryOptions Retry { get; set; } = new global::Neon.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Neon.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Neon.IAutoSDKHook>();
        ...
        public global::Neon.AutoSDKClientOptions AddHook(
            global::Neon.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Neon.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Neon.AutoSDKClientOptions UseAuthorizationProvider(
            global::Neon.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Neon.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Neon.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Neon.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Neon.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Neon.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Neon.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Neon.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Neon.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Neon.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Neon.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Neon.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Neon.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Neon.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Neon.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Neon.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Neon.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Neon.AutoSDKClientOptions clientOptions,
            global::Neon.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Neon.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Neon.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Neon.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Neon.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Neon.IAutoSDKHook, global::Neon.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Neon.AutoSDKHookContext context)
        {
