...
namespace Neon
{
    public partial class DataAPIClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_DeleteProjectBranchDataAPISecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_DeleteProjectBranchDataAPISecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_DeleteProjectBranchDataAPISecurityRequirement0,
            };
        partial void PrepareDeleteProjectBranchDataAPIArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string databaseName);
        partial void PrepareDeleteProjectBranchDataAPIRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            string databaseName);
        partial void ProcessDeleteProjectBranchDataAPIResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteProjectBranchDataAPIResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EmptyResponse> DeleteProjectBranchDataAPIAsync(
            string projectId,
            string branchId,
            string databaseName,
        ...
        {
            var __response = await DeleteProjectBranchDataAPIAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.EmptyResponse>> DeleteProjectBranchDataAPIAsResponseAsync(
            string projectId,
            string branchId,
            string databaseName,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteProjectBranchDataAPIArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteProjectBranchDataAPISecurityRequirements,
                operationName: "DeleteProjectBranchDataAPIAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteProjectBranchDataAPIRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteProjectBranchDataAPIAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteProjectBranchDataAPIResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteProjectBranchDataAPIResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
