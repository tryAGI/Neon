...
namespace Neon
{
    public partial class ProjectClient
    {
        ...
        {
            await AcceptProjectTransferRequestAsResponseAsync(
                projectId: projectId,
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse> AcceptProjectTransferRequestAsResponseAsync(
            string projectId,
            string requestId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AcceptProjectTransferRequestAsync",
                                pathTemplate: "$\"/projects/{projectId}/transfer_requests/{requestId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 406)
                            {
                                ...
                                throw global::Neon.ApiException<global::Neon.AcceptProjectTransferRequestSatisfiesPlanError>.Create(
