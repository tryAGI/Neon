...
namespace Neon
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Neon.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Neon.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Neon.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Neon.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Neon.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Neon.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Neon.ApiException exception)
        ...
        private static global::Neon.AutoSDKRequestOptions CloneRequestOptions(
            global::Neon.AutoSDKRequestOptions? source)
        {
            var clone = new global::Neon.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
