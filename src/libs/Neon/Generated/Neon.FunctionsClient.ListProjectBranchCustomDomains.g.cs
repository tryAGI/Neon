...
namespace Neon
{
    public partial class FunctionsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_ListProjectBranchCustomDomainsSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_ListProjectBranchCustomDomainsSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_ListProjectBranchCustomDomainsSecurityRequirement0,
            };
        partial void PrepareListProjectBranchCustomDomainsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? cursor,
            ref int? limit,
            ref string projectId,
            ref string branchId);
        partial void PrepareListProjectBranchCustomDomainsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string projectId,
            string branchId);
        partial void ProcessListProjectBranchCustomDomainsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectBranchCustomDomainsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.AllOf<global::Neon.CustomDomainsListResponse, global::Neon.CursorPaginationResponse>> ListProjectBranchCustomDomainsAsync(
            string projectId,
            string branchId,
        ...
        {
            var __response = await ListProjectBranchCustomDomainsAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                cursor: cursor,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.AllOf<global::Neon.CustomDomainsListResponse, global::Neon.CursorPaginationResponse>>> ListProjectBranchCustomDomainsAsResponseAsync(
            string projectId,
            string branchId,
            string? cursor = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectBranchCustomDomainsArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListProjectBranchCustomDomainsSecurityRequirements,
                operationName: "ListProjectBranchCustomDomainsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListProjectBranchCustomDomainsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListProjectBranchCustomDomainsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListProjectBranchCustomDomainsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectBranchCustomDomainsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.AllOf<global::Neon.CustomDomainsListResponse, global::Neon.CursorPaginationResponse>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.AllOf<global::Neon.CustomDomainsListResponse, global::Neon.CursorPaginationResponse>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.AllOf<global::Neon.CustomDomainsListResponse, global::Neon.CursorPaginationResponse>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
