...
namespace Neon
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateNeonAuthMagicLinkPluginSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateNeonAuthMagicLinkPluginSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateNeonAuthMagicLinkPluginSecurityRequirement0,
            };
        partial void PrepareUpdateNeonAuthMagicLinkPluginArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            global::Neon.NeonAuthMagicLinkConfigUpdate request);
        partial void PrepareUpdateNeonAuthMagicLinkPluginRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            global::Neon.NeonAuthMagicLinkConfigUpdate request);
        partial void ProcessUpdateNeonAuthMagicLinkPluginResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateNeonAuthMagicLinkPluginResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthMagicLinkConfig> UpdateNeonAuthMagicLinkPluginAsync(
            string projectId,
            string branchId,
        ...
        {
            var __response = await UpdateNeonAuthMagicLinkPluginAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthMagicLinkConfig>> UpdateNeonAuthMagicLinkPluginAsResponseAsync(
            string projectId,
            string branchId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateNeonAuthMagicLinkPluginArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateNeonAuthMagicLinkPluginSecurityRequirements,
                operationName: "UpdateNeonAuthMagicLinkPluginAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/auth/plugins/magic-link",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateNeonAuthMagicLinkPluginRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateNeonAuthMagicLinkPluginAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/auth/plugins/magic-link\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateNeonAuthMagicLinkPluginResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateNeonAuthMagicLinkPluginResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.NeonAuthMagicLinkConfig.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthMagicLinkConfig>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.NeonAuthMagicLinkConfig.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthMagicLinkConfig> UpdateNeonAuthMagicLinkPluginAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.NeonAuthMagicLinkConfigUpdate
            {
                Enabled = enabled,
                ExpiresIn = expiresIn,
            ...
            return await UpdateNeonAuthMagicLinkPluginAsync(
                projectId: projectId,
                branchId: branchId,
                request: __request,
                requestOptions: requestOptions,
