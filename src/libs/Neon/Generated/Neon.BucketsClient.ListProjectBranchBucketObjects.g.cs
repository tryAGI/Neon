...
namespace Neon
{
    public partial class BucketsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_ListProjectBranchBucketObjectsSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_ListProjectBranchBucketObjectsSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_ListProjectBranchBucketObjectsSecurityRequirement0,
            };
        partial void PrepareListProjectBranchBucketObjectsArguments(
        ...
        partial void PrepareListProjectBranchBucketObjectsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string branchId,
            string bucketName);
        partial void ProcessListProjectBranchBucketObjectsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectBranchBucketObjectsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.BucketObjectsListResponse> ListProjectBranchBucketObjectsAsync(
            string projectId,
            string branchId,
            string bucketName,
        ...
        {
            var __response = await ListProjectBranchBucketObjectsAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.BucketObjectsListResponse>> ListProjectBranchBucketObjectsAsResponseAsync(
            string projectId,
            string branchId,
            string bucketName,
            string? prefix = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectBranchBucketObjectsArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListProjectBranchBucketObjectsSecurityRequirements,
                operationName: "ListProjectBranchBucketObjectsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/buckets/{bucketName}/objects",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListProjectBranchBucketObjectsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListProjectBranchBucketObjectsAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/buckets/{bucketName}/objects\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListProjectBranchBucketObjectsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectBranchBucketObjectsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.BucketObjectsListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.BucketObjectsListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.BucketObjectsListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
