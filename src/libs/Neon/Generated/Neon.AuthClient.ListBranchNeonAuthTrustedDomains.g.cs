...
namespace Neon
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_ListBranchNeonAuthTrustedDomainsSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_ListBranchNeonAuthTrustedDomainsSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_ListBranchNeonAuthTrustedDomainsSecurityRequirement0,
            };
        partial void PrepareListBranchNeonAuthTrustedDomainsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId);
        partial void PrepareListBranchNeonAuthTrustedDomainsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId);
        partial void ProcessListBranchNeonAuthTrustedDomainsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListBranchNeonAuthTrustedDomainsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// Lists the trusted domains in the redirect URI whitelist for the specified branch.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthRedirectURIWhitelistResponse> ListBranchNeonAuthTrustedDomainsAsync(
            string projectId,
            string branchId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListBranchNeonAuthTrustedDomainsAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthRedirectURIWhitelistResponse>> ListBranchNeonAuthTrustedDomainsAsResponseAsync(
            string projectId,
            string branchId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListBranchNeonAuthTrustedDomainsArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListBranchNeonAuthTrustedDomainsSecurityRequirements,
                operationName: "ListBranchNeonAuthTrustedDomainsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListBranchNeonAuthTrustedDomainsAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/auth/domains\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListBranchNeonAuthTrustedDomainsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListBranchNeonAuthTrustedDomainsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.NeonAuthRedirectURIWhitelistResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthRedirectURIWhitelistResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.NeonAuthRedirectURIWhitelistResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
