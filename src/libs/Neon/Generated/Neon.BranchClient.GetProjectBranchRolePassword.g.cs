...
namespace Neon
{
    public partial class BranchClient
    {
        ...
        partial void PrepareGetProjectBranchRolePasswordArguments(
            ...
            ref string branchId,
            ref string roleName);
        partial void PrepareGetProjectBranchRolePasswordRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            string roleName);
        partial void ProcessGetProjectBranchRolePasswordResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectBranchRolePasswordResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.RolePasswordResponse> GetProjectBranchRolePasswordAsync(
            string projectId,
            string branchId,
            string roleName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProjectBranchRolePasswordAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/roles/{roleName}/reveal_password\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProjectBranchRolePasswordResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 412)
                            {
                                ...
                                global::Neon.GeneralError? __value_412 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProjectBranchRolePasswordResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
