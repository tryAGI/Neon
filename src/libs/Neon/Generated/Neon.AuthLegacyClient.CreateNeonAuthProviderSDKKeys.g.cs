...
namespace Neon
{
    public partial class AuthLegacyClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_CreateNeonAuthProviderSDKKeysSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_CreateNeonAuthProviderSDKKeysSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_CreateNeonAuthProviderSDKKeysSecurityRequirement0,
            };
        partial void PrepareCreateNeonAuthProviderSDKKeysArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Neon.NeonAuthCreateAuthProviderSDKKeysRequest request);
        partial void PrepareCreateNeonAuthProviderSDKKeysRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Neon.NeonAuthCreateAuthProviderSDKKeysRequest request);
        partial void ProcessCreateNeonAuthProviderSDKKeysResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateNeonAuthProviderSDKKeysResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthCreateIntegrationResponse> CreateNeonAuthProviderSDKKeysAsync(

            global::Neon.NeonAuthCreateAuthProviderSDKKeysRequest request,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateNeonAuthProviderSDKKeysAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthCreateIntegrationResponse>> CreateNeonAuthProviderSDKKeysAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateNeonAuthProviderSDKKeysArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateNeonAuthProviderSDKKeysSecurityRequirements,
                operationName: "CreateNeonAuthProviderSDKKeysAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateNeonAuthProviderSDKKeysRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateNeonAuthProviderSDKKeysAsync",
                                pathTemplate: "\"/projects/auth/keys\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateNeonAuthProviderSDKKeysResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateNeonAuthProviderSDKKeysResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.NeonAuthCreateIntegrationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthCreateIntegrationResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.NeonAuthCreateIntegrationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthCreateIntegrationResponse> CreateNeonAuthProviderSDKKeysAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.NeonAuthCreateAuthProviderSDKKeysRequest
            {
                ProjectId = projectId,
                AuthProvider = authProvider,
            };

            return await CreateNeonAuthProviderSDKKeysAsync(
                request: __request,
                requestOptions: requestOptions,
