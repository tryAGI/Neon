...
namespace Neon
{
    public partial class ProjectClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_SetProjectMemberRoleSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_SetProjectMemberRoleSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_SetProjectMemberRoleSecurityRequirement0,
            };
        partial void PrepareSetProjectMemberRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? confirmSelfDemotion,
            ref string projectId,
            ref string memberId,
            global::Neon.SetProjectMemberRoleRequest request);
        partial void PrepareSetProjectMemberRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? confirmSelfDemotion,
            string projectId,
            string memberId,
            global::Neon.SetProjectMemberRoleRequest request);
        partial void ProcessSetProjectMemberRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetProjectMemberRoleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.ProjectMemberRoleResponse> SetProjectMemberRoleAsync(
            string projectId,
            string memberId,
        ...
        {
            var __response = await SetProjectMemberRoleAsResponseAsync(
                projectId: projectId,
                memberId: memberId,

                request: request,
                confirmSelfDemotion: confirmSelfDemotion,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.ProjectMemberRoleResponse>> SetProjectMemberRoleAsResponseAsync(
            string projectId,
            string memberId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSetProjectMemberRoleArguments(
                httpClient: HttpClient,
                confirmSelfDemotion: ref confirmSelfDemotion,
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetProjectMemberRoleSecurityRequirements,
                operationName: "SetProjectMemberRoleAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/members/{memberId}/role",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("confirm_self_demotion", confirmSelfDemotion?.ToString().ToLowerInvariant())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSetProjectMemberRoleRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SetProjectMemberRoleAsync",
                                pathTemplate: "$\"/projects/{projectId}/members/{memberId}/role\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSetProjectMemberRoleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetProjectMemberRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.ProjectMemberRoleResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.ProjectMemberRoleResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.ProjectMemberRoleResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.ProjectMemberRoleResponse> SetProjectMemberRoleAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.SetProjectMemberRoleRequest
            {
                Role = role,
            };

            return await SetProjectMemberRoleAsync(
                confirmSelfDemotion: confirmSelfDemotion,
                projectId: projectId,
                memberId: memberId,
                request: __request,
