...
namespace Neon
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateNeonAuthUserRoleSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateNeonAuthUserRoleSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateNeonAuthUserRoleSecurityRequirement0,
            };
        partial void PrepareUpdateNeonAuthUserRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string authUserId,
            global::Neon.UpdateNeonAuthUserRoleRequest request);
        partial void PrepareUpdateNeonAuthUserRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string authUserId,
            global::Neon.UpdateNeonAuthUserRoleRequest request);
        partial void ProcessUpdateNeonAuthUserRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateNeonAuthUserRoleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.UpdateNeonAuthUserRoleResponse> UpdateNeonAuthUserRoleAsync(
            string projectId,
            string branchId,
            string authUserId,
        ...
        {
            var __response = await UpdateNeonAuthUserRoleAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.UpdateNeonAuthUserRoleResponse>> UpdateNeonAuthUserRoleAsResponseAsync(
            string projectId,
            string branchId,
            string authUserId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateNeonAuthUserRoleArguments(
                httpClient: HttpClient,
                projectId: ref projectId,
                branchId: ref branchId,
                authUserId: ref authUserId,
                request: request);


            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_UpdateNeonAuthUserRoleSecurityRequirements,
                operationName: "UpdateNeonAuthUserRoleAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/auth/users/{authUserId}/role",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateNeonAuthUserRoleAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/auth/users/{authUserId}/role\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateNeonAuthUserRoleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateNeonAuthUserRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.UpdateNeonAuthUserRoleResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.UpdateNeonAuthUserRoleResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.UpdateNeonAuthUserRoleResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.UpdateNeonAuthUserRoleResponse> UpdateNeonAuthUserRoleAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.UpdateNeonAuthUserRoleRequest
            {
                Roles = roles,
            };

            return await UpdateNeonAuthUserRoleAsync(
                projectId: projectId,
                branchId: branchId,
                authUserId: authUserId,
                request: __request,
