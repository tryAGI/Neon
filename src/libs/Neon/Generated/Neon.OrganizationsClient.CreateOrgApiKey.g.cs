...
namespace Neon
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_CreateOrgApiKeySecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_CreateOrgApiKeySecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_CreateOrgApiKeySecurityRequirement0,
            };
        partial void PrepareCreateOrgApiKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            global::Neon.OrgApiKeyCreateRequest request);
        partial void PrepareCreateOrgApiKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            global::Neon.OrgApiKeyCreateRequest request);
        partial void ProcessCreateOrgApiKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateOrgApiKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.OrgApiKeyCreateResponse> CreateOrgApiKeyAsync(
            string orgId,
        ...
        {
            var __response = await CreateOrgApiKeyAsResponseAsync(
                orgId: orgId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.OrgApiKeyCreateResponse>> CreateOrgApiKeyAsResponseAsync(
            string orgId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateOrgApiKeyArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateOrgApiKeySecurityRequirements,
                operationName: "CreateOrgApiKeyAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateOrgApiKeyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateOrgApiKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateOrgApiKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.OrgApiKeyCreateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.OrgApiKeyCreateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.OrgApiKeyCreateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.OrgApiKeyCreateResponse> CreateOrgApiKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.OrgApiKeyCreateRequest
            {
            };

            return await CreateOrgApiKeyAsync(
                orgId: orgId,
                request: __request,
                requestOptions: requestOptions,
