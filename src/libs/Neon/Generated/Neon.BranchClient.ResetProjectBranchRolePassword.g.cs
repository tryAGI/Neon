...
namespace Neon
{
    public partial class BranchClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_ResetProjectBranchRolePasswordSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_ResetProjectBranchRolePasswordSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_ResetProjectBranchRolePasswordSecurityRequirement0,
            };
        partial void PrepareResetProjectBranchRolePasswordArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string roleName);
        partial void PrepareResetProjectBranchRolePasswordRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            string roleName);
        partial void ProcessResetProjectBranchRolePasswordResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessResetProjectBranchRolePasswordResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.RoleOperations> ResetProjectBranchRolePasswordAsync(
            string projectId,
            string branchId,
            string roleName,
        ...
        {
            var __response = await ResetProjectBranchRolePasswordAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                roleName: roleName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.RoleOperations>> ResetProjectBranchRolePasswordAsResponseAsync(
            string projectId,
            string branchId,
            string roleName,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareResetProjectBranchRolePasswordArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ResetProjectBranchRolePasswordSecurityRequirements,
                operationName: "ResetProjectBranchRolePasswordAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ResetProjectBranchRolePasswordAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessResetProjectBranchRolePasswordResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessResetProjectBranchRolePasswordResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
