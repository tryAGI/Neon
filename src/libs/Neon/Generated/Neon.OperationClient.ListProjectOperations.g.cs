...
namespace Neon
{
    public partial class OperationClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_ListProjectOperationsSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_ListProjectOperationsSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_ListProjectOperationsSecurityRequirement0,
            };
        partial void PrepareListProjectOperationsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? cursor,
            ref int? limit,
            ref string projectId);
        partial void PrepareListProjectOperationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? cursor,
            int? limit,
            string projectId);
        partial void ProcessListProjectOperationsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListProjectOperationsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.AllOf<global::Neon.OperationsResponse, global::Neon.PaginationResponse>> ListProjectOperationsAsync(
            string projectId,
        ...
        {
            var __response = await ListProjectOperationsAsResponseAsync(
                projectId: projectId,
                cursor: cursor,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.AllOf<global::Neon.OperationsResponse, global::Neon.PaginationResponse>>> ListProjectOperationsAsResponseAsync(
            string projectId,
            string? cursor = default,
            int? limit = default,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListProjectOperationsArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListProjectOperationsSecurityRequirements,
                operationName: "ListProjectOperationsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListProjectOperationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListProjectOperationsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListProjectOperationsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListProjectOperationsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.AllOf<global::Neon.OperationsResponse, global::Neon.PaginationResponse>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.AllOf<global::Neon.OperationsResponse, global::Neon.PaginationResponse>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.AllOf<global::Neon.OperationsResponse, global::Neon.PaginationResponse>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
