...
namespace Neon
{
    public partial class ProjectClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_RemoveProjectMemberRoleSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_RemoveProjectMemberRoleSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_RemoveProjectMemberRoleSecurityRequirement0,
            };
        partial void PrepareRemoveProjectMemberRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? confirmSelfLockout,
            ref string projectId,
            ref string memberId);
        partial void PrepareRemoveProjectMemberRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? confirmSelfLockout,
            string projectId,
            string memberId);
        partial void ProcessRemoveProjectMemberRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveProjectMemberRoleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.ProjectMemberRoleResponse> RemoveProjectMemberRoleAsync(
            string projectId,
            string memberId,
        ...
        {
            var __response = await RemoveProjectMemberRoleAsResponseAsync(
                projectId: projectId,
                memberId: memberId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.ProjectMemberRoleResponse>> RemoveProjectMemberRoleAsResponseAsync(
            string projectId,
            string memberId,
            bool? confirmSelfLockout = default,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveProjectMemberRoleArguments(
                httpClient: HttpClient,
                confirmSelfLockout: ref confirmSelfLockout,
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveProjectMemberRoleSecurityRequirements,
                operationName: "RemoveProjectMemberRoleAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("confirm_self_lockout", confirmSelfLockout?.ToString().ToLowerInvariant())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRemoveProjectMemberRoleRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveProjectMemberRoleAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveProjectMemberRoleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveProjectMemberRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
