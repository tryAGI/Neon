...
namespace Neon
{
    public partial class BranchClient
    {
        ...
        partial void PrepareGetProjectBranchSchemaArguments(
            ...
            ref string? format);
        partial void PrepareGetProjectBranchSchemaRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? format);
        partial void ProcessGetProjectBranchSchemaResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectBranchSchemaResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.BranchSchemaResponse> GetProjectBranchSchemaAsync(
            string projectId,
            string branchId,
            string dbName,
            string? lsn = default,
        ...
        {
            var __response = await GetProjectBranchSchemaAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                dbName: dbName,
                lsn: lsn,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.BranchSchemaResponse>> GetProjectBranchSchemaAsResponseAsync(
            string projectId,
            string branchId,
            string dbName,
            string? lsn = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetProjectBranchSchemaArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProjectBranchSchemaAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/schema\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProjectBranchSchemaResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProjectBranchSchemaResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.BranchSchemaResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.BranchSchemaResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.BranchSchemaResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
