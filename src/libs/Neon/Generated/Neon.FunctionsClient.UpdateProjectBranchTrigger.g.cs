...
namespace Neon
{
    public partial class FunctionsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateProjectBranchTriggerSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateProjectBranchTriggerSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateProjectBranchTriggerSecurityRequirement0,
            };
        partial void PrepareUpdateProjectBranchTriggerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string triggerId,
            global::Neon.TriggerUpdateRequest request);
        partial void PrepareUpdateProjectBranchTriggerRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string triggerId,
            global::Neon.TriggerUpdateRequest request);
        partial void ProcessUpdateProjectBranchTriggerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectBranchTriggerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.TriggerResponse> UpdateProjectBranchTriggerAsync(
            string projectId,
            string branchId,
            string triggerId,
        ...
        {
            var __response = await UpdateProjectBranchTriggerAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                triggerId: triggerId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.TriggerResponse>> UpdateProjectBranchTriggerAsResponseAsync(
            string projectId,
            string branchId,
            string triggerId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectBranchTriggerArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectBranchTriggerSecurityRequirements,
                operationName: "UpdateProjectBranchTriggerAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/triggers/{triggerId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateProjectBranchTriggerRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateProjectBranchTriggerAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectBranchTriggerResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectBranchTriggerResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
