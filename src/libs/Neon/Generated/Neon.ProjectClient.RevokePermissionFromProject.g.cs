...
namespace Neon
{
    public partial class ProjectClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_RevokePermissionFromProjectSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_RevokePermissionFromProjectSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_RevokePermissionFromProjectSecurityRequirement0,
            };
        partial void PrepareRevokePermissionFromProjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string permissionId);
        partial void PrepareRevokePermissionFromProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string permissionId);
        partial void ProcessRevokePermissionFromProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRevokePermissionFromProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.ProjectPermission> RevokePermissionFromProjectAsync(
            string projectId,
            string permissionId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RevokePermissionFromProjectAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.ProjectPermission>> RevokePermissionFromProjectAsResponseAsync(
            string projectId,
            string permissionId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRevokePermissionFromProjectArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RevokePermissionFromProjectSecurityRequirements,
                operationName: "RevokePermissionFromProjectAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RevokePermissionFromProjectAsync",
                                pathTemplate: "$\"/projects/{projectId}/permissions/{permissionId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRevokePermissionFromProjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRevokePermissionFromProjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
