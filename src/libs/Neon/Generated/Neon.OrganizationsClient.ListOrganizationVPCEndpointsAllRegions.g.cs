...
namespace Neon
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_ListOrganizationVPCEndpointsAllRegionsSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_ListOrganizationVPCEndpointsAllRegionsSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_ListOrganizationVPCEndpointsAllRegionsSecurityRequirement0,
            };
        partial void PrepareListOrganizationVPCEndpointsAllRegionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId);
        partial void PrepareListOrganizationVPCEndpointsAllRegionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId);
        partial void ProcessListOrganizationVPCEndpointsAllRegionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListOrganizationVPCEndpointsAllRegionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.VPCEndpointsWithRegionResponse> ListOrganizationVPCEndpointsAllRegionsAsync(
            string orgId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListOrganizationVPCEndpointsAllRegionsAsResponseAsync(
                orgId: orgId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.VPCEndpointsWithRegionResponse>> ListOrganizationVPCEndpointsAllRegionsAsResponseAsync(
            string orgId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListOrganizationVPCEndpointsAllRegionsArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListOrganizationVPCEndpointsAllRegionsSecurityRequirements,
                operationName: "ListOrganizationVPCEndpointsAllRegionsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/organizations/{orgId}/vpc/vpc_endpoints",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListOrganizationVPCEndpointsAllRegionsAsync",
                                pathTemplate: "$\"/organizations/{orgId}/vpc/vpc_endpoints\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListOrganizationVPCEndpointsAllRegionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListOrganizationVPCEndpointsAllRegionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.VPCEndpointsWithRegionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.VPCEndpointsWithRegionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.VPCEndpointsWithRegionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
