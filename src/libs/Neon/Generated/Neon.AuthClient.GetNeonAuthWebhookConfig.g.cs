...
namespace Neon
{
    public partial class AuthClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_GetNeonAuthWebhookConfigSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_GetNeonAuthWebhookConfigSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_GetNeonAuthWebhookConfigSecurityRequirement0,
            };
        partial void PrepareGetNeonAuthWebhookConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId);
        partial void PrepareGetNeonAuthWebhookConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId);
        partial void ProcessGetNeonAuthWebhookConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetNeonAuthWebhookConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Retrieve Neon Auth webhook configuration<br/>
        /// Returns the webhook configuration for the specified branch's Neon Auth integration,<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthWebhookConfig> GetNeonAuthWebhookConfigAsync(
            string projectId,
            string branchId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetNeonAuthWebhookConfigAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthWebhookConfig>> GetNeonAuthWebhookConfigAsResponseAsync(
            string projectId,
            string branchId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetNeonAuthWebhookConfigArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetNeonAuthWebhookConfigSecurityRequirements,
                operationName: "GetNeonAuthWebhookConfigAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetNeonAuthWebhookConfigRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetNeonAuthWebhookConfigAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/auth/webhooks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetNeonAuthWebhookConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetNeonAuthWebhookConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.NeonAuthWebhookConfig.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthWebhookConfig>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.NeonAuthWebhookConfig.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
