...
namespace Neon
{
    public partial class FunctionsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateProjectBranchFunctionSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateProjectBranchFunctionSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateProjectBranchFunctionSecurityRequirement0,
            };
        partial void PrepareUpdateProjectBranchFunctionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string slug,
            global::Neon.NeonFunctionUpdateRequest request);
        partial void PrepareUpdateProjectBranchFunctionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string slug,
            global::Neon.NeonFunctionUpdateRequest request);
        partial void ProcessUpdateProjectBranchFunctionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectBranchFunctionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonFunctionResponse> UpdateProjectBranchFunctionAsync(
            string projectId,
            string branchId,
            string slug,
        ...
        {
            var __response = await UpdateProjectBranchFunctionAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.NeonFunctionResponse>> UpdateProjectBranchFunctionAsResponseAsync(
            string projectId,
            string branchId,
            string slug,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectBranchFunctionArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectBranchFunctionSecurityRequirements,
                operationName: "UpdateProjectBranchFunctionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/functions/{slug}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateProjectBranchFunctionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateProjectBranchFunctionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectBranchFunctionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectBranchFunctionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.NeonFunctionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.NeonFunctionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.NeonFunctionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonFunctionResponse> UpdateProjectBranchFunctionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.NeonFunctionUpdateRequest
            {
                Name = name,
            };

            return await UpdateProjectBranchFunctionAsync(
                projectId: projectId,
                branchId: branchId,
                slug: slug,
                request: __request,
