...
namespace Neon
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_SetOrganizationSpendingLimitSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_SetOrganizationSpendingLimitSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_SetOrganizationSpendingLimitSecurityRequirement0,
            };
        partial void PrepareSetOrganizationSpendingLimitArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            global::Neon.SpendingLimitUpdateRequest request);
        partial void PrepareSetOrganizationSpendingLimitRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            global::Neon.SpendingLimitUpdateRequest request);
        partial void ProcessSetOrganizationSpendingLimitResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetOrganizationSpendingLimitResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.SpendingLimitResponse> SetOrganizationSpendingLimitAsync(
            string orgId,
        ...
        {
            var __response = await SetOrganizationSpendingLimitAsResponseAsync(
                orgId: orgId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.SpendingLimitResponse>> SetOrganizationSpendingLimitAsResponseAsync(
            string orgId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSetOrganizationSpendingLimitArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetOrganizationSpendingLimitSecurityRequirements,
                operationName: "SetOrganizationSpendingLimitAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/organizations/{orgId}/billing/spending_limit",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SetOrganizationSpendingLimitAsync",
                                pathTemplate: "$\"/organizations/{orgId}/billing/spending_limit\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSetOrganizationSpendingLimitResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetOrganizationSpendingLimitResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.SpendingLimitResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.SpendingLimitResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.SpendingLimitResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.SpendingLimitResponse> SetOrganizationSpendingLimitAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.SpendingLimitUpdateRequest
            {
                SpendingLimitCents = spendingLimitCents,
            };

            return await SetOrganizationSpendingLimitAsync(
                orgId: orgId,
                request: __request,
                requestOptions: requestOptions,
