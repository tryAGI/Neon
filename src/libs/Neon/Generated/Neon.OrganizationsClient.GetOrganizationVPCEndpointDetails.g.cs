...
namespace Neon
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_GetOrganizationVPCEndpointDetailsSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_GetOrganizationVPCEndpointDetailsSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_GetOrganizationVPCEndpointDetailsSecurityRequirement0,
            };
        partial void PrepareGetOrganizationVPCEndpointDetailsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            ref string regionId,
            ref string vpcEndpointId);
        partial void PrepareGetOrganizationVPCEndpointDetailsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            string regionId,
            string vpcEndpointId);
        partial void ProcessGetOrganizationVPCEndpointDetailsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetOrganizationVPCEndpointDetailsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.VPCEndpointDetails> GetOrganizationVPCEndpointDetailsAsync(
            string orgId,
            string regionId,
            string vpcEndpointId,
        ...
        {
            var __response = await GetOrganizationVPCEndpointDetailsAsResponseAsync(
                orgId: orgId,
                regionId: regionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.VPCEndpointDetails>> GetOrganizationVPCEndpointDetailsAsResponseAsync(
            string orgId,
            string regionId,
            string vpcEndpointId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetOrganizationVPCEndpointDetailsArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOrganizationVPCEndpointDetailsSecurityRequirements,
                operationName: "GetOrganizationVPCEndpointDetailsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/organizations/{orgId}/vpc/region/{regionId}/vpc_endpoints/{vpcEndpointId}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetOrganizationVPCEndpointDetailsAsync",
                                pathTemplate: "$\"/organizations/{orgId}/vpc/region/{regionId}/vpc_endpoints/{vpcEndpointId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetOrganizationVPCEndpointDetailsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetOrganizationVPCEndpointDetailsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.VPCEndpointDetails.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.VPCEndpointDetails>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.VPCEndpointDetails.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
