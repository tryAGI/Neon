...
namespace Neon
{
    public partial class BucketsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_DeleteProjectBranchBucketObjectsByPrefixSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_DeleteProjectBranchBucketObjectsByPrefixSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_DeleteProjectBranchBucketObjectsByPrefixSecurityRequirement0,
            };
        partial void PrepareDeleteProjectBranchBucketObjectsByPrefixArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string prefix,
            ref string projectId,
            ref string branchId,
            ref string bucketName);
        partial void PrepareDeleteProjectBranchBucketObjectsByPrefixRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string branchId,
            string bucketName);
        partial void ProcessDeleteProjectBranchBucketObjectsByPrefixResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteProjectBranchBucketObjectsByPrefixResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.BucketObjectsDeletePrefixResponse> DeleteProjectBranchBucketObjectsByPrefixAsync(
            string prefix,
            string projectId,
            string branchId,
            string bucketName,
        ...
        {
            var __response = await DeleteProjectBranchBucketObjectsByPrefixAsResponseAsync(
                prefix: prefix,
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.BucketObjectsDeletePrefixResponse>> DeleteProjectBranchBucketObjectsByPrefixAsResponseAsync(
            string prefix,
            string projectId,
            string branchId,
            string bucketName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteProjectBranchBucketObjectsByPrefixArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteProjectBranchBucketObjectsByPrefixSecurityRequirements,
                operationName: "DeleteProjectBranchBucketObjectsByPrefixAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/buckets/{bucketName}/objects-by-prefix",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddRequiredParameter("prefix", prefix)
                                ;
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteProjectBranchBucketObjectsByPrefixAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteProjectBranchBucketObjectsByPrefixResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteProjectBranchBucketObjectsByPrefixResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.BucketObjectsDeletePrefixResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.BucketObjectsDeletePrefixResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.BucketObjectsDeletePrefixResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
