...
{
    /// <inheritdoc />
    public class AllOfJsonConverter<T1, T2, T3, T4, T5, T6, T7> : global::System.Text.Json.Serialization.JsonConverter<global::Neon.AllOf<T1, T2, T3, T4, T5, T6, T7>>
    {
        /// <inheritdoc />
        public override global::Neon.AllOf<T1, T2, T3, T4, T5, T6, T7> Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __value = new global::Neon.AllOf<T1, T2, T3, T4, T5, T6, T7>(
                value1,
        ...
        public override void Write(
            ...
            global::Neon.AllOf<T1, T2, T3, T4, T5, T6, T7> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsValue5)
            {
                ...
                foreach (var __property in __element4.EnumerateObject())
                {
                    if (__writtenPropertyNames.Add(__property.Name))
                    {
                        __property.WriteTo(writer);
            ...
            if (value.IsValue6)
            {
                ...
                foreach (var __property in __element5.EnumerateObject())
                {
                    if (__writtenPropertyNames.Add(__property.Name))
                    {
                        __property.WriteTo(writer);
            ...
            if (value.IsValue7)
            {
                ...
                foreach (var __property in __element6.EnumerateObject())
                {
                    if (__writtenPropertyNames.Add(__property.Name))
                    {
                        __property.WriteTo(writer);
