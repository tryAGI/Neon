...
namespace Neon
{
    public partial class CredentialsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_RevokeCredentialSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_RevokeCredentialSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_RevokeCredentialSecurityRequirement0,
            };
        partial void PrepareRevokeCredentialArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string tokenId);
        partial void PrepareRevokeCredentialRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            string tokenId);
        partial void ProcessRevokeCredentialResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RevokeCredentialAsync(
            string projectId,
            string branchId,
            string tokenId,
        ...
        {
            await RevokeCredentialAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                tokenId: tokenId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse> RevokeCredentialAsResponseAsync(
            string projectId,
            string branchId,
            string tokenId,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRevokeCredentialArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RevokeCredentialSecurityRequirements,
                operationName: "RevokeCredentialAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/credentials/{tokenId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRevokeCredentialRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RevokeCredentialAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/credentials/{tokenId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRevokeCredentialResponse(
                    httpClient: HttpClient,
