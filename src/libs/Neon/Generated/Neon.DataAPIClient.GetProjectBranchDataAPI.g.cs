...
namespace Neon
{
    public partial class DataAPIClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_GetProjectBranchDataAPISecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_GetProjectBranchDataAPISecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_GetProjectBranchDataAPISecurityRequirement0,
            };
        partial void PrepareGetProjectBranchDataAPIArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string databaseName);
        partial void PrepareGetProjectBranchDataAPIRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            string databaseName);
        partial void ProcessGetProjectBranchDataAPIResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectBranchDataAPIResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.DataAPIReponse> GetProjectBranchDataAPIAsync(
            string projectId,
            string branchId,
            string databaseName,
        ...
        {
            var __response = await GetProjectBranchDataAPIAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.DataAPIReponse>> GetProjectBranchDataAPIAsResponseAsync(
            string projectId,
            string branchId,
            string databaseName,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetProjectBranchDataAPIArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetProjectBranchDataAPISecurityRequirements,
                operationName: "GetProjectBranchDataAPIAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetProjectBranchDataAPIRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProjectBranchDataAPIAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProjectBranchDataAPIResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProjectBranchDataAPIResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.DataAPIReponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.DataAPIReponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.DataAPIReponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
