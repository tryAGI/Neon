...
namespace Neon
{
    public partial class DataAPIClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_UpdateProjectBranchDataAPISecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_UpdateProjectBranchDataAPISecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_UpdateProjectBranchDataAPISecurityRequirement0,
            };
        partial void PrepareUpdateProjectBranchDataAPIArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string databaseName,
            global::Neon.DataAPIUpdateRequest request);
        partial void PrepareUpdateProjectBranchDataAPIRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string databaseName,
            global::Neon.DataAPIUpdateRequest request);
        partial void ProcessUpdateProjectBranchDataAPIResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateProjectBranchDataAPIResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EmptyResponse> UpdateProjectBranchDataAPIAsync(
            string projectId,
            string branchId,
            string databaseName,
        ...
        {
            var __response = await UpdateProjectBranchDataAPIAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.EmptyResponse>> UpdateProjectBranchDataAPIAsResponseAsync(
            string projectId,
            string branchId,
            string databaseName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateProjectBranchDataAPIArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateProjectBranchDataAPISecurityRequirements,
                operationName: "UpdateProjectBranchDataAPIAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateProjectBranchDataAPIRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateProjectBranchDataAPIAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateProjectBranchDataAPIResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateProjectBranchDataAPIResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.EmptyResponse> UpdateProjectBranchDataAPIAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.DataAPIUpdateRequest
            {
                Settings = settings,
            };

            return await UpdateProjectBranchDataAPIAsync(
                projectId: projectId,
                branchId: branchId,
                databaseName: databaseName,
                request: __request,
