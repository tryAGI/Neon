...
namespace Neon
{
    public partial class AuthLegacyClient
    {


        private static readonly global::Neon.EndPointSecurityRequirement s_TransferNeonAuthProviderProjectSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_TransferNeonAuthProviderProjectSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_TransferNeonAuthProviderProjectSecurityRequirement0,
            };
        partial void PrepareTransferNeonAuthProviderProjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Neon.NeonAuthTransferAuthProviderProjectRequest request);
        partial void PrepareTransferNeonAuthProviderProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Neon.NeonAuthTransferAuthProviderProjectRequest request);
        partial void ProcessTransferNeonAuthProviderProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTransferNeonAuthProviderProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthTransferAuthProviderProjectResponse> TransferNeonAuthProviderProjectAsync(

            global::Neon.NeonAuthTransferAuthProviderProjectRequest request,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TransferNeonAuthProviderProjectAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthTransferAuthProviderProjectResponse>> TransferNeonAuthProviderProjectAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTransferNeonAuthProviderProjectArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TransferNeonAuthProviderProjectSecurityRequirements,
                operationName: "TransferNeonAuthProviderProjectAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTransferNeonAuthProviderProjectRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "TransferNeonAuthProviderProjectAsync",
                                pathTemplate: "\"/projects/auth/transfer_ownership\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTransferNeonAuthProviderProjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTransferNeonAuthProviderProjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.NeonAuthTransferAuthProviderProjectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.NeonAuthTransferAuthProviderProjectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.NeonAuthTransferAuthProviderProjectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.NeonAuthTransferAuthProviderProjectResponse> TransferNeonAuthProviderProjectAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.NeonAuthTransferAuthProviderProjectRequest
            {
                ProjectId = projectId,
                AuthProvider = authProvider,
            };

            return await TransferNeonAuthProviderProjectAsync(
                request: __request,
                requestOptions: requestOptions,
