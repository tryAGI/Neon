...
namespace Neon
{
    public partial class BucketsClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_PresignProjectBranchBucketObjectSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_PresignProjectBranchBucketObjectSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_PresignProjectBranchBucketObjectSecurityRequirement0,
            };
        partial void PreparePresignProjectBranchBucketObjectArguments(
        ...
        partial void PreparePresignProjectBranchBucketObjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string objectKey,
            global::Neon.PresignRequest request);
        partial void ProcessPresignProjectBranchBucketObjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPresignProjectBranchBucketObjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.PresignResponse> PresignProjectBranchBucketObjectAsync(
            string projectId,
            string branchId,
            string bucketName,
            string objectKey,
        ...
        {
            var __response = await PresignProjectBranchBucketObjectAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.PresignResponse>> PresignProjectBranchBucketObjectAsResponseAsync(
            string projectId,
            string branchId,
            string bucketName,
            string objectKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePresignProjectBranchBucketObjectArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PresignProjectBranchBucketObjectSecurityRequirements,
                operationName: "PresignProjectBranchBucketObjectAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Neon.PathBuilder(
                                path: $"/projects/{projectId}/branches/{branchId}/buckets/{bucketName}/objects/{objectKey}/presign",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePresignProjectBranchBucketObjectRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PresignProjectBranchBucketObjectAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/buckets/{bucketName}/objects/{objectKey}/presign\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPresignProjectBranchBucketObjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPresignProjectBranchBucketObjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.PresignResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.PresignResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.PresignResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.PresignResponse> PresignProjectBranchBucketObjectAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Neon.PresignRequest
            {
                Operation = operation,
            ...
            return await PresignProjectBranchBucketObjectAsync(
                projectId: projectId,
                branchId: branchId,
                bucketName: bucketName,
                objectKey: objectKey,
