...
namespace Neon
{
    public partial class BranchClient
    {
        ...
        private static readonly global::Neon.EndPointSecurityRequirement s_DeleteProjectBranchRoleSecurityRequirement0 =
        ...
        private static readonly global::Neon.EndPointSecurityRequirement[] s_DeleteProjectBranchRoleSecurityRequirements =
            new global::Neon.EndPointSecurityRequirement[]
            {                s_DeleteProjectBranchRoleSecurityRequirement0,
            };
        partial void PrepareDeleteProjectBranchRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string branchId,
            ref string roleName);
        partial void PrepareDeleteProjectBranchRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string branchId,
            string roleName);
        partial void ProcessDeleteProjectBranchRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteProjectBranchRoleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// Delete role<br/>
        /// Deletes the specified Postgres role from the branch.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Neon.RoleOperations> DeleteProjectBranchRoleAsync(
            string projectId,
            string branchId,
            string roleName,
        ...
        {
            var __response = await DeleteProjectBranchRoleAsResponseAsync(
                projectId: projectId,
                branchId: branchId,
                roleName: roleName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Neon.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Neon.AutoSDKHttpResponse<global::Neon.RoleOperations>> DeleteProjectBranchRoleAsResponseAsync(
            string projectId,
            string branchId,
            string roleName,
            global::Neon.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteProjectBranchRoleArguments(
            ...
            var __authorizations = global::Neon.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteProjectBranchRoleSecurityRequirements,
                operationName: "DeleteProjectBranchRoleAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteProjectBranchRoleRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Neon.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Neon.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteProjectBranchRoleAsync",
                                pathTemplate: "$\"/projects/{projectId}/branches/{branchId}/roles/{roleName}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteProjectBranchRoleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Neon.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteProjectBranchRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Neon.RoleOperations.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Neon.AutoSDKHttpResponse<global::Neon.RoleOperations>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Neon.RoleOperations.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
